...
def main():
    ...
    for i in range(0, 1):
        for i in range(start_page, end_page+1):
            urls.append("http://api.scraperapi.com?api_key=cf1dfe285ad7b62e5387b4ad6e3fe1b5&url=https://www.ebay-kleinanzeigen.de/seite:{}/apple/k0".format(i))
                ...
                try:
                    ...
                    for i in getofferurls:
                        ...
                        if len(profiles) > 0:
                            ...
                            #y = 'http://api.scraperapi.com?api_key=cf1dfe285ad7b62e5387b4ad6e3fe1b5&url=https://www.ebay-kleinanzeigen.de/s-bestandsliste.html?userId=125579346'
